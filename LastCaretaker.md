...
This project aims to **create an experimental multiplayer mode** for an Unreal Engine game **without modifying the original game project**.

The multiplayer system is implemented through:
- **DLL injection**
- **Dynamic memory reading/writing**
- **Peer-to-Peer (P2P) synchronization**

The goal is mainly **technical and experimental**, to prove that a multiplayer layer can be added *from scratch* to a single-player game.
